...
Original file is located at
    https://colab.research.google.com/drive/16vy6tBJMwWjGQWy3qcCaFHmZAQm2d11d
"""
...
# Styling CSS Custom agar mirip Odoo/SAP (Clean)
st.markdown("""
<style>
...
if 'db_initialized' not in st.session_state:
    ...
    # D. Resep Produksi (Bill of Materials Logic Sederhana)
    st.session_state['bom'] = {
        "Bijih Besi (Iron Ore)": {"Output": "Baja Lembaran (Steel Sheet)", "Ratio": 0.6}, # 1 Ton Ore jadi 0.6 Ton Baja
...
st.sidebar.caption("Automotive Upstream ERP")
st.sidebar.markdown("---")
...
if menu == "Dashboard Utama":
    ...
    total_value_est = total_vol * 150 # asumsi harga dummy
    ...
    if raw_mat.empty:
        ...
        with c2:
            ...
            if curr_batch['Item'] in st.session_state['bom']:
                ...
                qty_process = st.number_input("Jumlah Diproses (Ton)", min_value=1, max_value=int(curr_batch['Qty']))
...
# === SALES ===
    ...
    # Ambil data Finished Goods saja
    ...
    if fg_mat.empty:
        ...
        with st.form("so_form"):
            ...
            qty_sell = st.number_input("Jumlah Kirim", min_value=1, max_value=int(curr_item['Qty']))
...
# Footer
st.sidebar.markdown("---")
st.sidebar.caption("© 2024 AutoChain SCM Systems v1.0")
